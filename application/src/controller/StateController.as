...
public class StateController {
    ...
    public function initialize():void {
        ...
        var parametros:Object = LoaderInfo(Main.instance.root.loaderInfo).parameters;
        var flashvarsModulo:String = parametros['modulo'] || "";
        DebuggerManager.debug("config.getData", config.getData('modulo'))
        DebuggerManager.debug("flashvarsModulo", parametros['modulo'])
        ...
        } else if (flashvarsModulo != "") {
            gameDataName = '_gameData' + flashvarsModulo;
            AssetsManager.loadDataAssets('data/' + gameDataName + '.txt', { name: gameDataName, estimatedBytes: 4800, onComplete: continueInitialize });
        } else {
            continueInitialize()
        }
    ...
    public function continueInitialize(r:* = null):void {
        DebuggerManager.debug("hahahahahah", gameDataName)
